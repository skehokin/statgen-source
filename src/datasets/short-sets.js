...
const times = [" when put under pressure", " when bored", " infrequently", " deep inside", " when not feeling threatened", " on special occasions", " on the surface", " when with certain others", " with new people", " when left alone", " when tired"]
 ...
 const animals = ['ant','elephant', 'ferrets','rabbits', 'bats', 'hamsters', 'snake', 'turtle', 'raven', 'owl', 'fly', 'lizard', 'hedgehog', 'chinchilla', 'rat', 'stick insect', 'spider', 'chicken', 'dragon', 'lion', 'wolf', 'bear', 'tiger' ,'cat','dog'];
 const livingAreas = ['city', 'town', 'forest', 'country', 'conclave', 'temple', 'farm', 'dungeon', 'palace'];
...
export {goodEvil, lawChaos, animals, livingAreas, leaders, allRaces, times};