...
export const valueGoals = {
	...
	'social influence': [`to gain the ear of the ${listRand(leaders)}`, 'to champion my cause among the rich', 'to manipulate others', 'to get the better of others', 'to scam others', `to marry the ${listRand(leaders)}`, 'to improve the low status of my house', 'to improve my low status', 'to improve my lower-class accent so I can move in high society' ],
	 ...
	 'fitting in': ['to hide my strange qualities and stop the stares', 'to disguise myself well enough that even my close friends won\'t recognise me', 'to do exactly what my friends are doing', 'to find acceptance', 'to be able to hide', 'to receive my mother\'s approval', 'to keep myself safe by not attracting attention'],
	...
	'beauty': ['find an object of surpassing beauty', 'improve my personal aesthetics', 'make something incredibly beautiful', 'learn more about how to design beautiful gardens', 'learn more about how to design beautiful houses', 'learn more about how to design beautiful scrolls', 'learn more about how to design beautiful furniture'],
	'daughters': ['protect my daughter', 'raise my daughter right', 'find my daughter', 'find the right man for my daughter to marry', 'take revenge for my daughter', 'convince my daughter to speak to me again'],
	'sons': ['protect my son', 'raise my son right', 'find my son', 'find the right woman for my son to marry', 'take revenge for my son', 'convince my son to speak to me again'],
	'children': ['protect my children', 'raise my children right', 'find my children', 'find a prestigious family for my children to marry into', 'take revenge for my children', 'convince my children to speak to me again'],
	'pets': ['get more pets', 'keep my pets safe', `get a pet ${listRand(animals)}`, `train my pet ${listRand(animals)}`],
	'dominance': [`take over the ${listRand(livingAreas)}`, `teach those in the ${listRand(livingAreas)} who is really in charge`, `become a ${listRand(leaders)}`, `defeat the ${listRand(livingAreas)}`, 'intimidate my associates into doing as I say'],
	'humility': ['to find the strength to accept my flaws', 'to practice living with nothing'],
    ...
    "chastity": ['to keep my virginity until marriage', 'to atone for losing my virginity', 'to learn to repress my sexual urges'],
    "patience": ['to learn to wait for the right moment to strike', 'I have previously been too hastily and lost something I loved. I have to be more cautious and patient', 'patience is the key to getting what I want. I must wait and not waste resources.'],
      "determination":[],
      "revenge":[],
      "passion":[],
      "bravery":[],
      "sleep":[],
	'destruction': [`destroy the ${listRand(livingAreas)}`, `kill the ${listRand(leaders)}`, `kill all ${listRand(animalPlurals)}`, 'kill any who insult me',  `kill all ${listRand(peopleTypes)}`],
	'race': ['destroy the misconception that any race is better than mine', `kill every ${listRand(allRaces)}`]
